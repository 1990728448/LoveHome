package org.example.xinda_05.homepager.fragment.homepager.model;
 ...
 */
public class Home_pager_item_entity implements Parcelable {
    ...
    public static class ListBean implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeInt(this.parent_cate_id);
            dest.writeString(this.parent_cate_img_url);
            dest.writeString(this.parent_cate_name);
        }
        ...
        protected ListBean(Parcel in) {
            this.parent_cate_id = in.readInt();
            this.parent_cate_img_url = in.readString();
            this.parent_cate_name = in.readString();
        }
    ...
    public Home_pager_item_entity() {
    }

    protected Home_pager_item_entity(Parcel in) {
    ...
    public static final Parcelable.Creator<Home_pager_item_entity> CREATOR = new Parcelable.Creator<Home_pager_item_entity>() {
        @Override
        public Home_pager_item_entity createFromParcel(Parcel source) {
            return new Home_pager_item_entity(source);
        }

        @Override
        public Home_pager_item_entity[] newArray(int size) {
            return new Home_pager_item_entity[size];
        }
    };
}
